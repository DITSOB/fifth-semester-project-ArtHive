            ...
            <div class="card p-3 py-4">
                <div class="text-center mt-3">
                    ...
                    <div class="buttons" style="display: flex; justify-content: center;">
                        <form action="{{ route('auction') }}" style="width: 150px;">
                            <button type="submit" class="btn-log btn-lg btn-outline-primary btn-login px-4">Auction&nbsp;<i class="fa fa-gavel"></i></button>
                        </form>
                        <form action="{{ route('cart') }}" style="width: 150px;">
                            <button type="submit" class="btn-log btn-lg btn-primary btn-login px-4 ms-3">Cart&nbsp;<i class="bi bi-cart"></i></button>
                        </form>
                    </div>
